...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~gBlknKzb#ANdmtJjo4iM_xSGBgu-PkWhY41RtDFaYVTIHd6G0Pxo",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "5yal",           // Owner's name
    DEV: process.env.DEV || "923439850348",                     // Developer's contact number
